...
function CartComponent({ handleClick, openCart, cart, setCart, total, setTotal}: CartComponentProps) {
    ...
    return (
        <>
            ...
            {/* Panel del carrito */}
            <div className={`h-screen w-90 md:w-110 bg-black fixed top-0 right-0 z-40 transition-transform duration-300 ease-in-out border-l border-[#666] ${openCart ? "translate-x-0" : "translate-x-full"} flex flex-col justify-between`}>
